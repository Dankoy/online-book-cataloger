...
public class InitBooksChangeLog {
  ...
  public void insertWorks(MongoDatabase db) {
    ...
    var doc1 =
        new Document()
            ...
            .append(
                "description",
                "After thousands of years of expansion and conquest, the imperium of man is at its"
                    + " height. His dream for humanity nearly accomplished, the emperor hands over"
    ...
    var doc2 =
        new Document()
            ...
            .append(
                "description",
                "The human Imperium stands at its height of glory - thousands of worlds have been"
                    + " brought to heel by the conquering armies of mankind. At the peak of his"
                    + " powers, Warmaster Horus wields absolute control - but can even he resist"
                    + " the corrupting whispers of Chaos?")
            .append("genres", getHorusHeresyGenres())
            ...
            new Document()
                ...
                .append(
                    ...
                    "After thousands of years of expansion and conquest, the imperium of man is at"
                        + " its height. His dream for humanity nearly accomplished, the emperor"
                        + " hands over the reins of power to his warmaster, Horus, and heads back"
                        + " to Terra. But is Horus strong enough to control his fellow commanders"
    ...
    List<Document> docs2 =
        List.of(
            new Document()
                ...
                .append(
                    "description",
                    "The human Imperium stands at its height of glory - thousands of worlds have"
                        + " been brought to heel by the conquering armies of mankind. At the peak"
                        + " of his powers, Warmaster Horus wields absolute control - but can even"
                        + " he resist the corrupting whispers of Chaos?")
  ...
  public void addEditionToWork(MongoDatabase db) {
    ...
    var workToUpdate1 = new Document().append("_id", new ObjectId(workId1));

    var workToUpdate2 = new Document().append("_id", new ObjectId(workId2));
