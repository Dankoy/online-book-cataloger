...
public class CommentaryRestController {
  ...
  public CommentaryDTO createCommentaryToWork(
      @PathVariable String workId, @RequestBody CommentaryCreateDTO dto) {
  ...
  public CommentaryDTO update(@PathVariable String id, @RequestBody CommentaryCreateDTO dto) {
